// Saudi Central Bank (SAMA) exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/sama';
...
/** Latest rate for one pair, e.g. getRate('EUR', 'SAR', { apiKey }). */
